...
class TxBeacons(object):
    ...
    def beacon(self):
        ...
        frame[Dot11Beacon].timestamp = time() - self.boot_time #current_timestamp(self.boot_time)
        print(f"frame timestamp: {convert_timestamp_to_uptime(frame[Dot11Beacon].timestamp)}, time(): {time()}, boot_time: {self.boot_time}")
